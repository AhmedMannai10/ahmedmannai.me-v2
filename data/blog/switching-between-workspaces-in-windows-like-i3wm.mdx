...
draft: false
summary: 'Easily switch between multiple virtual desktops in Windows using a powerful AutoHotkey script that mimics the workspace-switching experience of the i3 window manager. (Alt + num / Win + num)'
---
...
The script bellow provide a great starting point. It allows you to easily switch between multiple virtual desktops in Windows, just like you would in i3wm. Let's break down how it works and how you can set it up on your system.
